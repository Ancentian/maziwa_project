                                ...
                                <ul class="notification-list">
                                    ...
                                    <li class="notification-message">
                                        <a href="activities.html">
                                            <div class="media">
                                                <span class="avatar">
                                                    <img alt="" src="<?php echo base_url(); ?>res/assets/img/profiles/avatar-06.jpg">
                                                </span>
                                                <div class="media-body">
                                    ...
                                    <li class="notification-message">
                                        <a href="activities.html">
                                            <div class="media">
                                                <span class="avatar">
                                                    <img alt="" src="<?php echo base_url(); ?>res/assets/img/profiles/avatar-17.jpg">
                                                </span>
                                                <div class="media-body">
                                    ...
                                    <li class="notification-message">
                                        <a href="activities.html">
                                            <div class="media">
                                                <span class="avatar">
                                                    <img alt="" src="<?php echo base_url(); ?>res/assets/img/profiles/avatar-13.jpg">
                                                </span>
                                                <div class="media-body">
                                    ...
                                    <li class="notification-message">
                                        <a href="chat.html">
                                            <div class="list-item">
                                                <div class="list-left">
                                                    <span class="avatar">
                                                        <img alt="" src="<?php echo base_url(); ?>res/assets/img/profiles/avatar-09.jpg">
                                                    </span>
                                                </div>
                                                <div class="list-body">
