				...
				<!-- <div> -->
					...
					<table class="table table-striped custom-table mb-0 " id="maziwa">
						...
						<tbody>
							<div class="form-group form-focus">
								<!-- <div class="cal-icon"> -->
									<input class="form-control floating " name="milkRate" type="text" required>
								<!-- </div> -->
							...
							<?php $i=1; foreach ($milkCollection as $key) { ?>
								<tr>
									...
									<td><input type="text" class="form-control" name="total_milk[]" value="<?php echo $key['totalMilk']?>" readonly></td>
