...
<html lang="en">
    <head>
        ...
        <title>Forgot Password | Maziwa</title>
			...
			<div class="account-content">
				<div class="container">
					...
					<div class="account-logo">
						<a href="index.html"><img src="<?php echo base_url(); ?>res/assets/img/logo2.png" alt="Dreamguy's Technologies"></a>
					</div>
					<!-- /Account Logo -->
						...
						<div class="account-wrapper">
							...
							<form>
								...
								<div class="account-footer">
									<p>Remember your password? <a href="<?php echo base_url('auth/index') ?>">Login</a></p>
								</div>
							</form>
							<!-- /Account Form -->
